 ...
 */
open class HybridEspProvToolkitSpec_cxx {
  /**
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridEspProvToolkitSpec_
   ...
   * The C++ part is a `std::shared_ptr<HybridEspProvToolkitSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridEspProvToolkitSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridEspProvToolkitSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridEspProvToolkitSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridEspProvToolkitSpec_cxx) -> Bool {
  ...
  public final func createESPDevice(deviceName: std.string, transport: Int32, security: Int32, proofOfPossession: bridge.std__optional_std__string_, softAPPassword: bridge.std__optional_std__string_, username: bridge.std__optional_std__string_) -> bridge.Result_std__shared_ptr_Promise_PTResult___ {
    do {
      let __result = try self.__implementation.createESPDevice(deviceName: String(deviceName), transport: margelo.nitro.espprovtoolkit.PTTransport(rawValue: transport)!, security: margelo.nitro.espprovtoolkit.PTSecurity(rawValue: security)!, proofOfPossession: { () -> String? in
        if bridge.has_value_std__optional_std__string_(proofOfPossession) {
          let __unwrapped = bridge.get_std__optional_std__string_(proofOfPossession)
          return String(__unwrapped)
        } else {
          return nil
        }
      }(), softAPPassword: { () -> String? in
        if bridge.has_value_std__optional_std__string_(softAPPassword) {
          let __unwrapped = bridge.get_std__optional_std__string_(softAPPassword)
          return String(__unwrapped)
        } else {
          return nil
        }
  ...
  @inline(__always)
  public final func getCurrentNetworkSSID() -> bridge.Result_std__shared_ptr_Promise_PTStringResult___ {
    do {
